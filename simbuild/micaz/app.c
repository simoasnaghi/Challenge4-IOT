...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bb1458, const void *arg_0xb7bb15f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b628c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a0c840), 
int (*key_eq_fn)(void *arg_0xb7a0cc88, void *arg_0xb7a0ce00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78db9b8, int arg_0xb78dbb10);
static double RandomUniform(void );
...
#line 130
static error_t sendAckC$AMControl$stop(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t sendAckC$PacketAck$requestAck(
#line 53
message_t * msg);
#line 85
static bool sendAckC$PacketAck$wasAcked(
#line 80
message_t * msg);
# 39 "sendAckC.nc"
...
const int sendAckC$STOPPER_CONST[1000];
...
#line 197
{
  ...
  if (len != sizeof(my_msg_t )) 
    {
      sim_log_error(166U, "radio_rec", "radio_rec: Wrong length. Message discarded. Time: %s.\n", sim_time_string());
      return buf;
    }
  else 
    {
      ...
      sim_log_debug(167U, "radio_pack", ">>Pack\n\t Payload received length %hhu \n", sendAckC$Packet$payloadLength(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(168U, "radio_pack", "\t\t type: %hhu \n", __nesc_ntoh_uint8(msg_received->msg_type.nxdata));
      sim_log_debug_clear(169U, "radio_pack", "\t\t counter: %hhu \n", __nesc_ntoh_uint8(msg_received->msg_counter.nxdata));

      if (TOS_NODE_ID == 2) 
        {
          sendAckC$counter[sim_node()] = __nesc_ntoh_uint8(msg_received->msg_counter.nxdata);
          if (__nesc_ntoh_uint8(msg_received->msg_type.nxdata) == 1) 
            {
              sim_log_debug(170U, "radio_rec", "radio_rec: Incoming message is ok. Proceding... Time: %s.\n", sim_time_string());
              sendAckC$sendResp();
            }
        }
      return buf;
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb767c178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb767c178, msg, payload, len);
#line 78
  ...
  if (err == SUCCESS) 
    {
      ...
      sim_log_debug(155U, "radio", "radio: radio started on node %d.\n", TOS_NODE_ID);
      sim_log_debug(156U, "radio", "radio: time %s.\n", sim_time_string());
    ...
    {
      sim_log_error(157U, "radio", "radio: radio ERROR on node %d.\n", TOS_NODE_ID);
      sim_log_error(158U, "radio", "radio: retry radio starting procedure on node %d.\n", TOS_NODE_ID);
      sim_log_error(159U, "radio", "radio: time %s.\n", sim_time_string());
...
#line 129
{
  ...
  sim_log_debug_clear(160U, "boot", "boot: radio stopped\n");
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7508088, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7508088) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7508088, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7837650){
#line 75
  switch (arg_0xb7837650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7837650);
#line 75
      break;
#line 75
    }
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t sendAckC$PacketAck$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
#line 236
{
  ...
  my_msg_t *msg_response = (my_msg_t *)sendAckC$Packet$getPayload(&sendAckC$packet[sim_node()], sizeof(my_msg_t ));

#line 246
  sim_log_debug(171U, "radio_rec", "radio_rec: read value ok. Time: %s\n", sim_time_string());
  if (msg_response == (void *)0) 
    {
      sim_log_error(172U, "radio_rec", "radio_rec: Empty response message. Time: %s\n", sim_time_string());
      return;
    }
  else 
    {
      __nesc_hton_uint8(msg_response->msg_type.nxdata, 2);
      __nesc_hton_uint8(msg_response->msg_counter.nxdata, sendAckC$counter[sim_node()]);
      __nesc_hton_uint32(msg_response->value.nxdata, (uint16_t )data);

      sim_log_debug(173U, "radio_ack", "radio_ack: Ack request. Time: %s\n", sim_time_string());
      sendAckC$PacketAck$requestAck(&sendAckC$packet[sim_node()]);


      if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) 
        {
          sendAckC$locked[sim_node()] = TRUE;
          sim_log_debug(174U, "radio_send", "radio_send: Msg sent. Time: %s\n", sim_time_string());

          sim_log_debug(175U, "radio_pack", ">>Pack\n\t Payload length %hhu \n", sendAckC$Packet$payloadLength(&sendAckC$packet[sim_node()]));
          sim_log_debug_clear(176U, "radio_pack", "\t\t type: %hhu \n", __nesc_ntoh_uint8(msg_response->msg_type.nxdata));
          sim_log_debug_clear(177U, "radio_pack", "\t\t counter: %hhu \n", __nesc_ntoh_uint8(msg_response->msg_counter.nxdata));
          sim_log_debug_clear(178U, "radio_pack", "\t\t data: %u \n", (unsigned int )__nesc_ntoh_uint32(msg_response->value.nxdata));
        }
    }
}
...
#line 52
{
  ...
  my_msg_t *msg_send = (my_msg_t *)sendAckC$Packet$getPayload(&sendAckC$packet[sim_node()], sizeof(my_msg_t ));
...
#line 64
  ...
  __nesc_hton_uint8(msg_send->msg_type.nxdata, 1);
  __nesc_hton_uint8(msg_send->msg_counter.nxdata, sendAckC$counter[sim_node()]);
  sim_log_debug(148U, "radio_pack", "radio_pack: Message is gettin ready.\n");
  ...
  if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) 
    {
      sendAckC$locked[sim_node()] = TRUE;
      sim_log_debug(149U, "radio_send", "radio_send: Message has been sent at time: %s.\n", sim_time_string());

      sim_log_debug(150U, "radio_pack", ">>Pack\n\t Payload length %hhu \n", sendAckC$Packet$payloadLength(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(151U, "radio_pack", "\t\t type: %hhu \n", __nesc_ntoh_uint8(msg_send->msg_type.nxdata));
      sim_log_debug_clear(152U, "radio_pack", "\t\t counter: %hhu \n", __nesc_ntoh_uint8(msg_send->msg_counter.nxdata));
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73733a8){
#line 83
  switch (arg_0xb73733a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73733a8);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7508a70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7508a70, addr, msg, len);
#line 80
...
inline static bool sendAckC$PacketAck$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
inline static error_t sendAckC$AMControl$stop(void ){
#line 130
  unsigned char __nesc_result;
#line 130
...
#line 98
{
  sim_log_debug_clear(153U, "boot", "Application booted.\n");
  sim_log_debug_clear(154U, "boot", "boot: time %s.\n", sim_time_string());
  ...
  if (&sendAckC$packet[sim_node()] == buf) 
    {
      ...
      sim_log_debug(161U, "radio_send", "radio_send: packet sent correctly. Time: %s.\n", sim_time_string());

      if (TOS_NODE_ID == 1) 
        {
          if (sendAckC$PacketAck$wasAcked(&sendAckC$packet[sim_node()])) 
            {
              sim_log_debug(162U, "radio_ack", "radio_ack: Message acked. Time: %s.\n", sim_time_string());
              sendAckC$rec_id[sim_node()]++;
              if (sendAckC$rec_id[sim_node()] == sendAckC$STOPPER_CONST[sim_node()]) 
                {
                  sendAckC$MilliTimer$stop();
                  sim_log_debug_clear(163U, "radio_send", "radio_send: Timer stopped. Time: %s.\n", sim_time_string());
                  sendAckC$AMControl$stop();
                }
              else 
                {
                  sim_log_debug(164U, "radio_send", "radio_send: New iteration upcoming. Counter: %hu.\n", sendAckC$counter[sim_node()]);
                  sim_log_debug(165U, "radio_send", "radio_send: Time: %s.\n", sim_time_string());
                }
            }
        }
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "sendAckC$STOPPER_CONST"))
  {
    *addr = (uintptr_t)&*(int *)&sendAckC$STOPPER_CONST[__nesc_mote];
    *size = sizeof(*(int *)&sendAckC$STOPPER_CONST[__nesc_mote]);
    return 0;
  }
