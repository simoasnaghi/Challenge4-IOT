...
t = Tossim([]);
#Definition of a constant (calculated from my personal code) that determines the start of the second mote
y=00; #personal code without the first and the last three digits.
